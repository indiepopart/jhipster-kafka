...
public class AlertKafkaResourceIT {
    ...
    @Autowired
    private AlertKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        AlertKafkaResource kafkaResource = new AlertKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/alert-kafka/publish?message=test"))
